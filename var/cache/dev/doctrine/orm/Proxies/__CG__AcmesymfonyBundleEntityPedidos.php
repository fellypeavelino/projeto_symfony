 ...
 */
class Pedidos extends \Acme\symfonyBundle\Entity\Pedidos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Acme\\symfonyBundle\\Entity\\Pedidos' . "\0" . 'id', '' . "\0" . 'Acme\\symfonyBundle\\Entity\\Pedidos' . "\0" . 'numero', '' . "\0" . 'Acme\\symfonyBundle\\Entity\\Pedidos' . "\0" . 'descricao'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pedidos $proxy) {
